<script>
    function sendMailToAllUnsubmittedTalks(templateId, templateSubject) {
        Swal.fire({
            title: 'Please Wait',
        ...
        $.get( "<?=base_url('admin/email/getAllUnsubmittedTalksEmail/json')?>", function(response) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    sendMailToAllUnsubmittedTalksConfirm(templateId);
                }
            });
    ...
    function sendMailToAllUnsubmittedTalksConfirm(templateId) {
        Swal.fire({
            title: 'Please Wait',
        ...
        $.get( "<?=base_url('admin/email/getTemplateById/')?>"+templateId, function(response) {
            ...
            if (response.status == 'success')
            {
                ...
                $.post( "<?=base_url('admin/email/sendToAllUnsubmittedTalks')?>",
                    {
